package com.example.paybazaarmyket.util;
...
import com.example.paybazaarmyket.util.communication.BillingSupportCommunication;
import com.example.paybazaarmyket.util.communication.OnConnectListener;
import org.json.JSONException;
import static com.example.paybazaarmyket.util.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static com.example.paybazaarmyket.util.IabHelper.IABHELPER_BAD_RESPONSE;
import static com.example.paybazaarmyket.util.IabHelper.IABHELPER_UNKNOWN_ERROR;
import static com.example.paybazaarmyket.util.IabHelper.IABHELPER_UNKNOWN_PURCHASE_RESPONSE;
import static com.example.paybazaarmyket.util.IabHelper.IABHELPER_USER_CANCELLED;
import static com.example.paybazaarmyket.util.IabHelper.IABHELPER_VERIFICATION_FAILED;
import static com.example.paybazaarmyket.util.IabHelper.RESPONSE_CODE;
import static com.example.paybazaarmyket.util.IabHelper.RESPONSE_INAPP_PURCHASE_DATA;
import static com.example.paybazaarmyket.util.IabHelper.RESPONSE_INAPP_SIGNATURE;
import static com.example.paybazaarmyket.util.IabHelper.getResponseDesc;
